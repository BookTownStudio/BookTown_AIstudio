...
const BooksSegment: React.FC = () => (
    <div className="h-full w-full bg-black overflow-y-auto scroll-snap-type-y-mandatory">
...
const QuoteFlowCard: React.FC<{ quote: Quote }> = ({ quote }) => {
    ...
    return (
        <div 
            className="relative h-screen w-screen flex-shrink-0 scroll-snap-align-start cursor-pointer bg-gradient-to-br from-slate-800 to-slate-900"
...
const VenueFlowCard: React.FC<{ venue: Venue }> = ({ venue }) => {
    ...
    return (
        <div 
            className="relative h-screen w-screen flex-shrink-0 scroll-snap-align-start cursor-pointer group"
...
const ForYouSegment: React.FC = () => {
    return (
        <div className="h-full w-full bg-slate-900 overflow-y-auto scroll-snap-type-y-mandatory">
