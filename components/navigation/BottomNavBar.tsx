...
const BottomNavBar: React.FC<BottomNavBarProps> = ({ activeTab }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-20 h-16 bg-gray-50/50 dark:bg-slate-900/50 backdrop-blur-lg border-t border-black/10 dark:border-white/10">
